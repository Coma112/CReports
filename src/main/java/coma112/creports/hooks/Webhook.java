...
public class Webhook {
    ...
    public static String replacePlaceholdersReportClaimed(@NotNull String text, final ReportClaimedEvent event) {
        return text.replace("{staff}", event.getClaimer().getName())
                .replace("{player}", event.getSender().getName())
                .replace("{target}", event.getTarget().getName());
    }

    public static String replacePlaceholdersReportCreated(@NotNull String text, final ReportCreatedEvent event) {
        return text.replace("{player}", Objects.requireNonNull(event.getSender().getName()))
                .replace("{target}", Objects.requireNonNull(event.getTarget().getName()))
